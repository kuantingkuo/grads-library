...
function spcol( kind )
  ...
  while( i <= length )
    ...
    if( c%c2 = '->' | c%c2 = '-(' | c = '>' | c = '(' | c = ')' | i = length )
      ...
      if( coltemp = 'drywet') ; coltemp = '(134,97,42)->(238,199,100)->(180,238,135)->(50,238,235)->(12,120,238)->(38,1,183)->(8,51,113)' ; endif
      ...
      if( coltemp = 'cwb') ; coltemp = '(200,190,195,0)-(0)->(160,255,250)->(0,205,255)->(0,150,255)->(0,105,250)-(0)->(50,150,0)->(50,255,0)-(0)->(255,255,0)->(255,200,0)->(255,150,0)-(0)->(255,0,0)->(200,0,0)->(160,0,0)-(0)->(150,0,155)->(200,0,210)->(255,0,245)->(255,200,255)' ; endif
      ...
      if( coltemp = 'exid') ; coltemp = '(116,116,193)->(224,98,135)->(241,230,178)' ; endif
      if( coltemp = 'exid_cycle') ; coltemp = '(116,116,193)->(224,98,135)->(241,230,178)->(116,116,193)' ; endif
