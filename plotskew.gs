...
thetwint= 5
tempint = 5
wsclevs = "0.7 1 1.5 2 3 4 5 7 10 15 20 25 30"
*
*
* ------------------------ Output Options --------------------------------
*
...
*-----------------------------------------------------------------------
function help()
say 'Usage: plotskew T Td U V'
say 'T: air temperature in Celsius'
say 'Td: dew-point temperature in Celsius'
say 'U: zonal wind speed'
say 'V: meridional wind speed'
